...
void printWindow(char symbolArray[500][500],std::vector<character> gameObjects, player thePlayer, WINDOW * workingWindow, WINDOW * statusWindow, WINDOW * message,Inventory playerInventory)
{
        int X;
        int Y;
    ...
    //prints inventory
    //if(symbolArray[playerX][playerY] == ' ')
    //{
  //      playerInventory.printInventoryArrays(message);
//    }
